...
<div class="main">
    <p class="short-input ue-clear">
        ...
        <input type="text" name="typeName" id="typeName" maxlength="20"/>
    </p>
    <p class="short-input ue-clear">
    	<label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;备注信息：</label>
...
<div class="btn ue-clear">
    ...
    <a href="${ctx}/admin/toBookTypePage.action" class="clear">返回</a>
</div>
</body>
...
function addType(){
	...
	$.post("${ctx}/admin/addType.action", { typeName:typeName,remark:remark},function(data){
