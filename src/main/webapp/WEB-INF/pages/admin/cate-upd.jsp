...
<body>
<div class="title"><h2>更新书架</h2></div>
<form action="${ctx}/admin/updCourse.action" method="post" name="myform" id="myform">
<div class="main">
	<p class="short-input ue-clear">
    	<label><span style="color:red">*</span>分类编号：</label>
        <input type="text" name="cateId" id="cateId" maxlength="10" value="${category.id }" readonly="readonly"/>
    </p>
    <p class="short-input ue-clear">
    	<label><span style="color:red">*</span>分类名称：</label>
        <input type="text" name="cateName" id="cateName" maxlength="10" value="${category.name }"/>
    </p>
	<p class="short-input ue-clear">
    	<label><span style="color:red">*</span>分类状态：</label>
        <input type="text" name="status" id="status" maxlength="10" value="${category.status }"/>
    </p>
	<p class="short-input ue-clear">
    	<label><span style="color:red">*</span>备注信息：</label>
        <input type="text" name="remark" id="remark" maxlength="10" value="${category.remark }"/>
    </p>
</div>
</form>
<div class="btn ue-clear">
	<a href="javascript:;" class="confirm" onclick="addType()">确定</a>
    <a href="${ctx}/admin/toCategoryPage.action" class="clear">返回</a>
</div>
</body>
